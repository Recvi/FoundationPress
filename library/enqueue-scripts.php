...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	...
	//
	wp_enqueue_style('main-stylesheet', get_template_directory_uri().'/assets/stylesheets/carlson/core.css', array(), '1.0.0', 'all');
	...
	// Carlson css files
	wp_enqueue_style('carlsonfonts', get_template_directory_uri().'/assets/stylesheets/carlson/fonts.css', array(), '1.0.0', 'all');
