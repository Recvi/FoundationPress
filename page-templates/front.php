...
<div class="orbit" role="region" aria-label="Favorite Space Pictures" data-orbit>
    <ul class="orbit-container">
      ...
      <li class="is-active orbit-slide">
        ...
        <figcaption class="orbit-caption my-caption">Welcome, to your new Intranet!</figcaption>
      </li>
      <li class="orbit-slide">
        <img class="orbit-image" src="<?php echo get_template_directory_uri().'/assets/images/carlson/orbit/02.jpg'?>" alt="Space">
        <figcaption class="orbit-caption my-caption">It contains everything you need to succeed!</figcaption>
      </li>
      <li class="orbit-slide">
        <img class="orbit-image" src="<?php echo get_template_directory_uri().'/assets/images/carlson/orbit/03.jpg'?>" alt="Space">
        <figcaption class="orbit-caption my-caption">And allows you to express yourself.</figcaption>
      </li>
      <li class="orbit-slide">
